...
public class GiantRatBossShadowEntity extends TamableAnimal implements GeoEntity {
	...
	public GiantRatBossShadowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlsbModEntities.GIANT_RAT_BOSS_SHADOW.get(), world);
	}

	public GiantRatBossShadowEntity(EntityType<GiantRatBossShadowEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "shadowkingrattexture");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GiantRatBossShadowEntity retval = SlsbModEntities.GIANT_RAT_BOSS_SHADOW.get().create(serverWorld);
