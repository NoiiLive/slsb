			...
			for (Entity entityiterator : _entfound) {
				if (singletarget == false) {
					if (!(entity == entityiterator) && !(entityiterator instanceof AfterImageEntity)) {
						singletarget = true;
						entityiterator.getPersistentData().putString("markedowner", (entity.getDisplayName().getString()));
						if (entity instanceof Player _player && !_player.level().isClientSide())
							_player.displayClientMessage(Component.literal(("\u00A7c\u00A7lMarked : " + entityiterator.getDisplayName().getString())), true);
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.evoker.cast_spell")), SoundSource.PLAYERS, 1, 1);
							} else {
								_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.evoker.cast_spell")), SoundSource.PLAYERS, 1, 1, false);
							}
						}
