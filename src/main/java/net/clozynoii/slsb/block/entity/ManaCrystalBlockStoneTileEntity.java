...
public class ManaCrystalBlockStoneTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ManaCrystalBlockStoneTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.MANA_CRYSTAL_BLOCK_STONE.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ManaCrystalBlockStoneTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ManaCrystalBlockStoneTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("mana_crystal_block_stone");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Mana Crystal (Stone)");
	}
