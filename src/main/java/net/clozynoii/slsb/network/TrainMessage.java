...
import net.clozynoii.slsb.procedures.TrainOnKeyPressedProcedure;
...
public class TrainMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SlsbMod.addNetworkMessage(TrainMessage.class, TrainMessage::buffer, TrainMessage::new, TrainMessage::handler);
	}
}
