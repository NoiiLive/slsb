...
public class GiantRatEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GiantRatEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GiantRatEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GiantRatEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> DATA_Color = SynchedEntityData.defineId(GiantRatEntity.class, EntityDataSerializers.STRING);
	...
	public GiantRatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlsbModEntities.GIANT_RAT.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, HunterNPCEntity.class, true, true));
	...
	public void die(DamageSource source) {
		super.die(source);
		EntityShadowSpawnProcedure.execute();
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata, tag);
		GiantRatOnSpawnProcedure.execute(this);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GiantRatEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
