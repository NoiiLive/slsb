...
public class RandomLootBoxItem extends Item implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new RandomLootBoxItemRenderer();
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		RandomLootboxOpenProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
