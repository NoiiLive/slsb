		...
		if ((world instanceof Level _lvl ? _lvl.dimension() : (world instanceof WorldGenLevel _wgl ? _wgl.getLevel().dimension() : Level.OVERWORLD)) == Level.OVERWORLD) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.BLUE_GATE_SMALL.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.BLUE_GATE_MEDIUM.get()
				...
				if ((new Object() {
					...
					entity.getPersistentData().putString("PhoneGateRank", (new Object() {
						public String getValue(LevelAccessor world, BlockPos pos, String tag) {
							BlockEntity blockEntity = world.getBlockEntity(pos);
							if (blockEntity != null)
								return blockEntity.getPersistentData().getString(tag);
					...
					if (entity instanceof ServerPlayer _ent) {
						...
						NetworkHooks.openScreen((ServerPlayer) _ent, new MenuProvider() {
							...
							public Component getDisplayName() {
								return Component.literal("HunterPhoneNewPrice");
							}

							@Override
							public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
								return new HunterPhoneNewPriceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
							}
						}, _bpos);
					}
				} else if ((new Object() {
					...
					if (!((entity.getCapability(SlsbModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SlsbModVariables.PlayerVariables())).HunterGuild).equals("None")) {
						...
						entity.getPersistentData().putDouble("PhoneGateTimer", (new Object() {
							public double getValue(LevelAccessor world, BlockPos pos, String tag) {
								BlockEntity blockEntity = world.getBlockEntity(pos);
								if (blockEntity != null)
									return blockEntity.getPersistentData().getDouble(tag);
						...
						}.getValue(world, BlockPos.containing(x, y, z), "GateCloseTimer")));
						if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.BLUE_GATE_SMALL.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.BLUE_GATE_MEDIUM.get()) {
							entity.getPersistentData().putBoolean("PhoneGateRed", false);
						}
						if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.RED_GATE_SMALL.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlsbModBlocks.RED_GATE_MEDIUM.get()) {
							entity.getPersistentData().putBoolean("PhoneGateRed", true);
						}
						if (entity instanceof ServerPlayer _ent) {
							BlockPos _bpos = BlockPos.containing(x, y, z);
							NetworkHooks.openScreen((ServerPlayer) _ent, new MenuProvider() {
