...
public class ModelJinwooShoes<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "jinwooshoes"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_shoe = partdefinition.addOrReplaceChild("left_shoe",
				CubeListBuilder.create().texOffs(70, 20)
						.addBox(-2.0F, 10.0F, -4.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 33)
						.addBox(-2.0F, 11.25F, -4.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(79, 3)
						.addBox(-2.0F, 10.0F, 1.25F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(73, 3)
						.addBox(1.25F, 10.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(72, 49)
		...
		PartDefinition left_leg_r1 = left_shoe.addOrReplaceChild("left_leg_r1",
				CubeListBuilder.create().texOffs(0, 47).addBox(-1.5F, -0.05F, -0.5F, 3.0F, 1.0F, 1.0F,
		...
		PartDefinition right_shoe = partdefinition.addOrReplaceChild("right_shoe", CubeListBuilder.create()
				.texOffs(70, 20).mirror().addBox(-2.0F, 10.0F, -4.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(42, 33).mirror()
				.addBox(-2.0F, 11.25F, -4.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(79, 3)
				.mirror().addBox(-2.0F, 10.0F, 1.25F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(73, 3).mirror().addBox(-2.25F, 10.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition right_leg_r1 = right_shoe.addOrReplaceChild("right_leg_r1",
				CubeListBuilder.create().texOffs(0, 47).mirror()
						.addBox(-1.5F, -0.05F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 9.75F, -2.75F, 1.0036F, 0.0F, 0.0F));
