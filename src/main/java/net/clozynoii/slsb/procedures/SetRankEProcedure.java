...
public class SetRankEProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!((new Object() {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				...
				}.getEntity()).getDisplayName().getString() + " Is Now E-Rank")), false);
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
				...
				_player.displayClientMessage(Component.literal("You Are Now E-Rank"), false);
		} else {
			if ((new Object() {
				public Entity getEntity() {
					try {
		...
		}
		{
			...
			}.getEntity()).getCapability(SlsbModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SlsbModVariables.PlayerVariables())).MaxStrength;
			(new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
