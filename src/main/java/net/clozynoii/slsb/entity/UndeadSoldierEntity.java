...
public class UndeadSoldierEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(UndeadSoldierEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(UndeadSoldierEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(UndeadSoldierEntity.class, EntityDataSerializers.STRING);
	...
	public UndeadSoldierEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlsbModEntities.UNDEAD_SOLDIER.get(), world);
	}

	public UndeadSoldierEntity(EntityType<UndeadSoldierEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "undeadsoldiertexture");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(UndeadSoldierEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
