...
public class UndeadSoldierShadowEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(UndeadSoldierShadowEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(UndeadSoldierShadowEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(UndeadSoldierShadowEntity.class, EntityDataSerializers.STRING);
	...
	public UndeadSoldierShadowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlsbModEntities.UNDEAD_SOLDIER_SHADOW.get(), world);
	}

	public UndeadSoldierShadowEntity(EntityType<UndeadSoldierShadowEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "shadowundeadsoldiertexture");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		UndeadSoldierShadowEntity retval = SlsbModEntities.UNDEAD_SOLDIER_SHADOW.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(UndeadSoldierShadowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
