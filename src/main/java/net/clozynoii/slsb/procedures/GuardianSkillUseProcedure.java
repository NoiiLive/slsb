...
public class GuardianSkillUseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
				...
				if (!(entityiterator == entity)) {
					if (entityiterator instanceof Player) {
						if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(SlsbModMobEffects.GUARDIAN.get(), 200, 0, false, true));
						entityiterator.getPersistentData().putString("Guardian", (entity.getDisplayName().getString()));
						if (world instanceof ServerLevel _level)
							_level.sendParticles(ParticleTypes.HEART, (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 5, 1, 1, 1, 0.1);
					}
				}
			}
		}
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.allay.item_thrown")), SoundSource.PLAYERS, 1, 1);
			} else {
				_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.allay.item_thrown")), SoundSource.PLAYERS, 1, 1, false);
			}
		}
		cooldown = 500;
